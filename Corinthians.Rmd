...
all_player_profiles <- c(Cássio, Fágner, F_Torres, Hugo, Caetano, M_Rojas, Maycon, Raniele, Matheus_Araújo, Ángel_Romero, Yuri_Alberto, Wesley, Fausto_Vera, Gustavo_Silva, Yago_Kauã)
...
# luxemburgo <- new("CoachProfile", name = "Vanderlei Luxemburgo", birth_date = as.Date("1952-05-10"))
```
...
validateGoals(season_2024_cp_round_2) 
